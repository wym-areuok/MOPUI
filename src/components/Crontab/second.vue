    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="59" /> {{ $t('page.cron秒') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="3">
                {{ $t('page.cron从') }}
                <el-input-number v-model='average01' :min="0" :max="58" /> {{ $t('page.cron秒开始每') }}
                <el-input-number v-model='average02' :min="1" :max="59 - average01" /> {{ $t('page.cron秒') }}{{ $t('page.cron执行一次') }}
            </el-radio>
        </el-form-item>
