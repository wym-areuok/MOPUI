    ...
    <div class="drawer-wrap">
      ...
      <template v-else>
        ...
        <div v-for="item in dataList" :key="item.dictCode" class="dict-item">
          <div class="dict-cell">
            <div class="dict-cell-key">{{ $t('page.标签') }}</div>
          ...
          <div class="dict-cell">
            <div class="dict-cell-key">{{ $t('page.键值') }}</div>
            <div class="dict-cell-val">{{ item.dictValue }}</div>
          </div>
          <div class="dict-cell">
            <div class="dict-cell-key">{{ $t('page.状态') }}</div>
            <div class="dict-cell-val">
              <el-tag :type="item.status === '0' ? 'success' : 'danger'" size="small">
                {{ item.status === '0' ? $t('page.正常') : $t('page.停用') }}
              </el-tag>
            </div>
          </div>
        </div>
