<template>
  <div class="app-container">
    ...
    <el-table ref="genRef" v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column :label="$t('page.序号')" type="index" width="50" align="center">
      ...
      <el-table-column :label="$t('page.操作')" align="center" width="330" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-tooltip :content="$t('page.预览')" placement="top">
            <el-button link type="primary" icon="View" @click="handlePreview(scope.row)" v-hasPermi="['tool:gen:preview']"></el-button>
          </el-tooltip>
          <el-tooltip :content="$t('page.编辑')" placement="top">
          ...
          <el-tooltip :content="$t('page.同步')" placement="top">
            <el-button link type="primary" icon="Refresh" @click="handleSynchDb(scope.row)" v-hasPermi="['tool:gen:edit']"></el-button>
          </el-tooltip>
          <el-tooltip :content="$t('page.生成代码')" placement="top">
