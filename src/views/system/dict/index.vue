<template>
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
         <el-form-item :label="$t('page.字典名称')" prop="dictName">
            <el-input
               v-model="queryParams.dictName"
               :placeholder="$t('page.请输入字典名称')"
               clearable
               style="width: 240px"
               @keyup.enter="handleQuery"
            />
         </el-form-item>
         <el-form-item :label="$t('page.字典类型')" prop="dictType">
            <el-input
               v-model="queryParams.dictType"
               :placeholder="$t('page.请输入字典类型')"
               clearable
               style="width: 240px"
               @keyup.enter="handleQuery"
            />
      ...
      <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
         ...
         <el-table-column :label="$t('page.字典编号')" align="center" prop="dictId" />
         <el-table-column :label="$t('page.字典名称')" align="center" prop="dictName" :show-overflow-tooltip="true"/>
         <el-table-column :label="$t('page.字典类型')" align="center" :show-overflow-tooltip="true">
         ...
         <el-table-column :label="$t('page.操作')" align="center" width="280" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:dict:edit']">{{ $t('page.修改') }}</el-button>
               <el-button link type="primary" icon="Operation" @click="handleDataList(scope.row)" v-hasPermi="['system:dict:edit']">{{ $t('page.列表') }}</el-button>
      ...
      <el-dialog :title="title" v-model="open" width="500px" append-to-body>
         <el-form ref="dictRef" :model="form" :rules="rules" label-width="100px">
            <el-form-item :label="$t('page.字典名称')" prop="dictName">
               <el-input v-model="form.dictName" :placeholder="$t('page.请输入字典名称')" />
            </el-form-item>
